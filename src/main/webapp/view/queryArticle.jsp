...
<script type="text/javascript">
    $("#su").click(function () {
        var param = $("#kw").val();
        alert(param + "111111");
        $.get("${pageContext.request.contextPath}/article/queryArticle", "param=" + param, function (result) {
            $.each(result, function (ind, Art) {
                var span = $("<span>文章名：" + Art.title + "  简介：" + Art.content + "</span></br><img src='http://192.168.199.135/" + Art.insertImg + "'/></br>")
                $("#ff").append(span);
            })
        })
    });
